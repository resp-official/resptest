...
const HyperRealisticSpaceMining = () => {
    ...
    // Performans için partikül sayısını 80'den 30'a düşürdük
    ...
    return (
        <div className="relative w-full h-[700px] flex items-center justify-center overflow-hidden rounded-[3rem] bg-[#02040a] shadow-[0_0_100px_rgba(0,0,0,0.8)] border border-white/5">
            <div className="absolute inset-0 z-0 overflow-hidden">
                ...
                {stars.map((star) => (
                    <motion.div 
                        ...
                        style={{ top: star.top, left: star.left, boxShadow: '0 0 3px rgba(255,255,255,0.4)' }}
                    />
                ))}
            </div>

            <motion.div animate={{ 
                scale: stage === 'launch' ? 0.95 : stage === 'transit' ? 0.75 : 2.2,
                ...
                <motion.div animate={{ opacity: stage === 'extraction' ? 0 : 1 }} transition={{ duration: 2 }} className="absolute z-10">
                    <div className="relative w-[1150px] h-[1150px] rounded-full shadow-[inset_-100px_-100px_180px_rgba(0,0,0,0.95)] overflow-hidden">
                        <motion.div animate={{ backgroundPositionX: ['0%', '100%'] }} transition={{ duration: 180, repeat: Infinity, ease: "linear" }}
                ...
                <motion.div animate={{ 
                    ...
                    <div className="relative w-80 h-40 bg-[#1e293b] rounded-2xl border-l-[15px] border-[#475569] overflow-hidden shadow-2xl">
                ...
                <motion.div animate={{ opacity: stage === 'launch' ? 0 : 1, x: 1300 }} transition={{ duration: 6 }} className="absolute z-20">
                    <div className="relative w-[1400px] h-[1400px] rounded-full bg-[#cbd5e1] shadow-[inset_-120px_-120px_250px_rgba(0,0,0,0.95)] overflow-hidden">
            ...
            <div className="absolute inset-0 z-50 pointer-events-none flex flex-col justify-center px-16 md:px-24">
                <div className="max-w-4xl text-left">
                    <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-4xl md:text-6xl font-display font-bold leading-[1.1] tracking-tighter mb-8">
                        Beyond Earth.<br />
                    ...
                    <motion.p initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="text-lg md:text-xl text-slate-100/90 max-w-xl font-light">
            ...
            <div className="absolute bottom-16 left-16 md:left-24 z-50 pointer-events-none">
                <div className="flex items-center gap-5">
                    ...
                    <span className="text-[12px] font-mono text-white/95 uppercase tracking-[0.5em] font-bold notranslate" translate="no">
    ...
    <div className="relative min-h-screen selection:bg-purple-500/30">
      ...
      <section className="relative pt-32 pb-20 px-6 min-h-[80vh] flex flex-col justify-center overflow-hidden">
        <div className="max-w-7xl mx-auto w-full flex flex-col gap-12">
          ...
          <div className="flex flex-col sm:flex-row gap-8 px-16 md:px-24 items-center">
              <button onClick={() => setIsMissionOpen(true)} className="bg-purple-600 hover:bg-purple-500 text-white px-12 py-5 rounded-3xl font-bold flex items-center gap-3 transition-all uppercase text-sm tracking-[0.2em] shadow-lg">Missions <ArrowRight /></button>
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-start">
            <div className="w-full lg:w-1/2 text-left">
              ...
              <form onSubmit={handleScan} className="relative group">
                ...
                <button type="submit" disabled={isScanning} className="absolute right-3 top-3 bottom-3 bg-cyan-500 text-black px-8 rounded-2xl font-bold transition-all hover:bg-cyan-400">{isScanning ? <Loader2 className="animate-spin" /> : <Search />}</button>
              </form>
            </div>
      ...
      <section id="roadmap" className="py-32 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {roadmap.map((item, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }} className="glass-panel p-8 rounded-3xl text-left border-purple-500/10 hover:border-purple-500/30 transition-colors">
      ...
      <footer id="contact" className="pt-32 pb-16 border-t border-white/5 bg-[#020408]">
        <div className="max-w-7xl mx-auto px-6">
          {/* Sosyal Medya Linkleri Geri Getirildi */}
